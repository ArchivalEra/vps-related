...
impl Stats {
    ...
    pub fn dump(&self, snap: &CacheSnap) -> String {
        let g = |c: &AtomicU64| c.load(Ordering::Relaxed);
        format!(
            "STATS {{\
\"in_dot\":{},\"in_doq\":{},\
\"cache_hit\":{},\"cache_miss\":{},\"cache_expired\":{},\"cache_evict\":{},\
\"cache_entries\":{},\"cache_bytes\":{},\"cache_cap\":{},\"cache_ttl_s\":{},\
...
\"cache_inserts\":{}}}",
            ...
            g(&self.cache_hit), g(&self.cache_miss), snap.expired, snap.evicts,
            snap.entries, snap.bytes, snap.cap_bytes, snap.ttl_secs,
